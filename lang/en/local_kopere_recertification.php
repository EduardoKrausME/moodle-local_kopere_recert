...
$string['bulkkopere_recertification'] = 'Recertificação em massa';
...
$string['event_kopere_recertification_completed'] = 'Recertificação concluída';
$string['event_kopere_recertification_completed_description'] = 'O ciclo {$a->cycleid} foi concluído pelo usuário {$a->userid} no curso {$a->courseid}.';
$string['event_kopere_recertification_created'] = 'Ciclo de recertificação criado';
$string['event_kopere_recertification_created_description'] = 'O ciclo {$a->cycleid} foi criado para o usuário {$a->userid} no curso {$a->courseid}.';
$string['event_kopere_recertification_failed'] = 'Falha na recertificação';
$string['event_kopere_recertification_failed_description'] = 'O ciclo {$a->cycleid} falhou para o usuário {$a->userid} no curso {$a->courseid}.';
$string['event_kopere_recertification_started'] = 'Recertificação iniciada';
$string['event_kopere_recertification_started_description'] = 'O ciclo {$a->cycleid} foi iniciado para o usuário {$a->userid} no curso {$a->courseid}.';
...
$string['kopere_recertificationlocked'] = 'Já existe uma recertificação deste usuário e curso em processamento.';
$string['kopere_recertificationpendingnav'] = 'Recertificação em andamento';
$string['kopere_recertificationqueued'] = 'A recertificação foi enfileirada para processamento isolado.';
$string['kopere_recertificationrequired'] = 'Recertificação obrigatória';
$string['kopere_recertificationstatusmessage'] = 'Sua certificação anterior não é mais considerada atual. Conclua novamente os requisitos do curso para finalizar esta recertificação.';
...
$string['notification_body_kopere_recertification_available'] = 'Uma nova recertificação do curso {{course.fullname}} está disponível.';
$string['notification_body_kopere_recertification_completed'] = 'Sua recertificação do curso {{course.fullname}} foi concluída.';
$string['notification_body_kopere_recertification_created'] = 'Um ciclo de recertificação foi criado para o curso {{course.fullname}}.';
$string['notification_body_kopere_recertification_due'] = 'A recertificação do curso {{course.fullname}} chegou à data prevista.';
$string['notification_body_kopere_recertification_expired'] = 'A sua certificação do curso {{course.fullname}} venceu e uma nova recertificação é obrigatória.';
$string['notification_body_kopere_recertification_started'] = 'Sua recertificação do curso {{course.fullname}} começou. Conclua novamente as atividades obrigatórias.';
$string['notification_subject_expiration_warning'] = 'Aviso de vencimento da certificação: {$a}';
$string['notification_subject_kopere_recertification_available'] = 'Recertificação disponível: {$a}';
$string['notification_subject_kopere_recertification_completed'] = 'Recertificação concluída: {$a}';
$string['notification_subject_kopere_recertification_created'] = 'Recertificação criada: {$a}';
$string['notification_subject_kopere_recertification_due'] = 'Recertificação vencendo: {$a}';
$string['notification_subject_kopere_recertification_expired'] = 'Certificação vencida: {$a}';
$string['notification_subject_kopere_recertification_started'] = 'Recertificação iniciada: {$a}';
$string['offsetdays'] = 'Dias antes do vencimento';
$string['origin'] = 'Origem';
$string['pluginname'] = 'Recertificação';
$string['privacy:metadata:local_recert_cycle'] = 'Armazena os ciclos de recertificação.';
$string['privacy:metadata:local_recert_cycle:courseid'] = 'Curso que está sendo recertificado.';
$string['privacy:metadata:local_recert_cycle:createdby'] = 'Usuário que criou ou solicitou o ciclo.';
$string['privacy:metadata:local_recert_cycle:reason'] = 'Motivo da recertificação.';
$string['privacy:metadata:local_recert_cycle:userid'] = 'Usuário proprietário do ciclo.';
$string['privacy:metadata:local_recert_file'] = 'Armazena metadados dos arquivos copiados para o histórico.';
$string['privacy:metadata:local_recert_file:userid'] = 'Usuário proprietário do arquivo histórico copiado.';
$string['privacy:metadata:local_recert_history'] = 'Armazena snapshots históricos permanentes.';
$string['privacy:metadata:local_recert_history:datajson'] = 'Dados históricos estruturados fornecidos pela tarefa.';
$string['privacy:metadata:local_recert_history:html'] = 'Dados históricos renderizados por uma atividade ou tarefa de sistema.';
$string['privacy:metadata:local_recert_history:userid'] = 'Usuário proprietário do snapshot histórico.';
$string['privacy:metadata:local_recert_log'] = 'Armazena logs de execução da recertificação.';
$string['privacy:metadata:local_recert_log:message'] = 'Mensagem técnica da execução sem segredos.';
$string['privacy:metadata:local_recert_notice_log'] = 'Armazena o controle de notificações já enviadas.';
$string['privacy:metadata:local_recert_notice_log:userid'] = 'Usuário que recebeu a notificação.';
...
$string['selfkopere_recertificationnotavailable'] = 'Uma nova recertificação estará disponível em {$a}.';
...
$string['selfreference_lastkopere_recertification'] = 'A partir do último ciclo de recertificação concluído';
...
$string['sqltemplatehelp'] = 'O Mustache pode usar {{#sqlecho}}...{{/sqlecho}} e {{#sqltable}}...{{/sqltable}}. O SQL é somente leitura e os valores devem usar os parâmetros :userid, :courseid, :cmid, :instanceid, :contextid, :cycleid ou :kopere_recertificationid.';
$string['startedat'] = 'Iniciada';
$string['startkopere_recertification'] = 'Iniciar recertificação';
...
$string['trigger_lastkopere_recertification'] = 'Após a última recertificação';
