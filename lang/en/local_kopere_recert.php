...
$string['cmid'] = 'CMID';
$string['competencycleanupfailed'] = 'Failed to reset the user competency data.';
...
$string['coursecompletioncleanupfailed'] = 'Failed to reset the user course completion data.';
...
$string['enrolpluginmissing'] = 'The enrolment plugin "{$a}" is not available.';
...
$string['kopere_recert:bulkrecertify'] = 'Bulk recertify users';
$string['kopere_recert:manage'] = 'Manage recertification';
$string['kopere_recert:managetasks'] = 'Manage recertification tasks';
$string['kopere_recert:recertify'] = 'Recertify users';
$string['kopere_recert:recertifyself'] = 'Request own recertification';
$string['kopere_recert:simulate'] = 'Simulate recertification';
$string['kopere_recert:viewallhistory'] = 'View all recertification histories';
$string['kopere_recert:viewownhistory'] = 'View own recertification history';
...
$string['messageprovider:kopere_recert_available'] = 'Recertification available';
$string['messageprovider:kopere_recert_completed'] = 'Recertification completed';
$string['messageprovider:kopere_recert_expired'] = 'Recertification expired';
$string['messageprovider:kopere_recert_started'] = 'Recertification started';
$string['messageprovider:kopere_recert_warning'] = 'Recertification expiration warning';
...
$string['subplugincomponentmissing'] = 'The configured subplugin is no longer installed.';
...
$string['subplugintype_recerttask_plural'] = 'Recertification tasks';
