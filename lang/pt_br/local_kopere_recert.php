...
$string['kopere_recert:bulkrecertify'] = 'Recertificar usuários em massa';
$string['kopere_recert:manage'] = 'Gerenciar recertificação';
$string['kopere_recert:managetasks'] = 'Gerenciar tarefas de recertificação';
$string['kopere_recert:recertify'] = 'Recertificar usuários';
$string['kopere_recert:recertifyself'] = 'Solicitar a própria recertificação';
$string['kopere_recert:simulate'] = 'Simular recertificação';
$string['kopere_recert:viewallhistory'] = 'Ver todos os históricos de recertificação';
$string['kopere_recert:viewownhistory'] = 'Ver o próprio histórico de recertificação';
...
$string['messageprovider:kopere_recert_available'] = 'Recertificação disponível';
$string['messageprovider:kopere_recert_completed'] = 'Recertificação concluída';
$string['messageprovider:kopere_recert_expired'] = 'Recertificação expirada';
$string['messageprovider:kopere_recert_started'] = 'Recertificação iniciada';
$string['messageprovider:kopere_recert_warning'] = 'Aviso de expiração da recertificação';
...
$string['subplugintype_recerttask_plural'] = 'Tarefas de recertificação';
