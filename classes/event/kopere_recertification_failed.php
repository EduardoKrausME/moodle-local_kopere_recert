...
/**
 * Moodle event emitted when a kopere_recertification cycle is failed.
 */
class kopere_recertification_failed extends base {
    /**
    ...
    public static function get_name(): string {
        return get_string('event_kopere_recertification_failed', 'local_kopere_recertification');
    }
    ...
    public function get_description(): string {
        return get_string('event_kopere_recertification_failed_description', 'local_kopere_recertification', (object)[
