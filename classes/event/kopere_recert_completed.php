...
/**
 * Moodle event emitted when a kopere_recert cycle is completed.
 */
class kopere_recert_completed extends base {
    /**
    ...
    public static function get_name(): string {
        return get_string('event_kopere_recert_completed', 'local_kopere_recert');
    }
    ...
    public function get_description(): string {
        return get_string('event_kopere_recert_completed_description', 'local_kopere_recert', (object)[
