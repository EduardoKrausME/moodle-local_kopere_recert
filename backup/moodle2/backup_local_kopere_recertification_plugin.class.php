 ...
 */
class backup_local_kopere_recertification_plugin extends backup_local_plugin {
    /**
    ...
    protected function define_course_plugin_structure() {
        ...
        $config = new backup_nested_element('kopere_recertification_config', ['id'], [
        ...
        $config->set_source_table('local_recert_course', ['courseid' => backup::VAR_COURSEID]);
        ...
        $notice->set_source_table('local_recert_notice', ['courseid' => backup::VAR_COURSEID]);
        ...
        if ($this->get_setting_value('userinfo')) {
            ...
            $cycle->set_source_table('local_recert_cycle', ['courseid' => backup::VAR_COURSEID]);
            $history->set_source_table('local_recert_history', ['cycleid' => backup::VAR_PARENTID]);
            $filemeta->set_source_table('local_recert_file', ['historyid' => backup::VAR_PARENTID]);
            ...
            $history->annotate_files('local_kopere_recertification', 'historyfiles', 'id');
        }
