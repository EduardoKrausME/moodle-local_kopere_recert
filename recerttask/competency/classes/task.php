...
final class task implements task_plugin_interface {
     ...
     */
    public static function get_component(): string { return 'core_competency'; }
    /**
     * Returns the localized name of this provider.
     */
    public static function get_name(): string { return get_string('pluginname', 'recerttask_competency'); }
    /**
    ...
    public function create_history(task_context $context): history_result {
        ...
        return new history_result(
            html: $OUTPUT->render_from_template('recerttask_competency/history', ['rows' => $rows, 'count' => count($rows)]),
    ...
    public function describe(task_context $context): array {
        return ['competencies' => count(user_competency_course::get_multiple($context->userid, $context->courseid))];
    }
}
